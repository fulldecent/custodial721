...
// Adapted from https://github.com/su-squares/ethereum-contract
...
contract BatchNFT is SupportsInterface2 {
    ...
    function initialize(uint256 newFixedSupplyAmount) public {
        fixedSupplyAmount = newFixedSupplyAmount;
    ...
    function tokenByIndex(uint256 _index) external view returns (uint256) {
        require(_index < fixedSupplyAmount);
        return _index + 1;
    }
